Meteor.startup(function() {
    if (typeof L !== 'undefined') {
        if (typeof L.DGis != 'object') {
            ...
            console.log('You don\'t need this module. L.DGis already exists!');
            console.log('Deinstall package to keep your code slick: "meteor remove rshashkov:2gis".')
        }
    } else {
        console.log('Leaflet Object [L] is missing. Did you add any Mapbox or Leaflet modules? (i.E. bevanhunt:leaflet)')
    }
});